...
class SolunarServiceTest extends TestCase
{
    ...
    public function test_service_gets_moon_rise_and_set()
    {
    ...
    public function test_service_gets_sun_rise_and_set()
    {
    ...
    public function test_service_gets_moon_phase()
    {
